...
const ValueCart = () => {
    const {totalItem, total, checkout, clearCart} = useContext(GlobalContext)
    return(
        <div id="valueCart">
            <Row><Col className="text-center">Total a pagar: {total}</Col></Row>
            <Row><Col className="text-center">Total art&iacute;culos: {totalItem}</Col></Row>
            <Row>
                <Col className="text-center">
                    <Button variant="light" onSubmit={checkout} >
